...
public class DbHelper {
    private static String DB_URL = "jdbc:mysql://localhost:3306/personelapplication";
    private static String DB_USER = "YOURUSERNAME";
    private static String DB_PASS = "YOUR PASSWORD";
